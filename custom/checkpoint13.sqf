...
Chkgrp16 = [getMarkerPos _spawnmrk, EAST, (configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfTeam")] call BIS_fnc_spawnGroup;
_wp1 = Chkgrp16 addwaypoint [getMarkerPos "wp13", 1000];
