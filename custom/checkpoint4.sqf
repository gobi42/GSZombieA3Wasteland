...
Chkgrp6 = [getMarkerPos _spawnmrk, EAST, (configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfTeam")] call BIS_fnc_spawnGroup;
_wp1 = Chkgrp6 addwaypoint [getMarkerPos "wp4", 1000];
