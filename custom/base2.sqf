...
Chkgrp5 = [getMarkerPos _spawnmrk, EAST, (configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfSquad")] call BIS_fnc_spawnGroup;  
_wp1 = Chkgrp5 addwaypoint [getMarkerPos "wpb2", 1000];
