...
Chkgrp4 = [getMarkerPos _spawnmrk, EAST, (configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfTeam")] call BIS_fnc_spawnGroup;
_wp1 = Chkgrp4 addwaypoint [getMarkerPos "wp3", 1000];
