...
[
	...
	["*MP7 Woodland", "C1987_Mp7_wcam", 150],
	["*AKS74", "hlc_rifle_aks74", 150],
	["*AKS74 (GL)", "hlc_rifle_aks74_GL", 150],
	["*AKS74U", "hlc_rifle_aks74u", 150],
...
[
	//Shotguns
	["SAIGA 12K", "hlc_rifle_saiga12k", 350],
	...
	["*AR15 Sanitised", "hlc_rifle_RU556", 150],
	...
	["*AEK-971", "hlc_rifle_aek971", 150],
	["*AK-12", "hlc_rifle_ak12", 150],
	["*AK-47", "hlc_rifle_ak47", 150],
	["*AK-74", "hlc_rifle_ak74", 150],
	["*AK-47 dirty", "hlc_rifle_ak47_dirty", 150],
	["*AKM", "hlc_rifle_akm", 400],
	["*AKM (GL)", "hlc_rifle_akmgl", 400],
	...
	["*CZ750 w/ Harris bipod (painted)", "Trixie_CZ750", 1000],
	["*CZ750 w/ Harris bipod (black)", "Trixie_CZ750_Black", 1000],
	["*CZ750 w/ Camo Net", "Trixie_CZ750_Ghillie", 1000],
	["*M110 w/ Camo Net (green)", "Trixie_M110", 1000],
	["*M110 SASS (green)", "Trixie_M110_NG", 1000],
	["*M110 SASS (black)", "Trixie_M110_NG_Black", 1000],

	// Sniper Rifles
	["*AS50", "Trixie_AS50", 1000],
	["*AWM .338 w/ Harris bipod (green)", "Trixie_AWM338", 1000],
	["*AWM .338 w/ Harris bipod (black)", "Trixie_AWM338_Black", 1000],
	["*AWM .338 w/ Camo Net", "Trixie_AWM338_Ghillie", 1000],
	["*M107 w/ Camo Net (green)", "Trixie_M107", 1000],
	["*M107 (Black)", "Trixie_M107_Black", 1000],
	["*M107 (green)", "Trixie_M107_Green", 1000],
...
[
	...
	["5.56mm SOST 30 rnd", "hlc_30rnd_556x45_SOST", 25],
	["5.56mm SPR 30 rnd", "hlc_30rnd_556x45_SPR", 25],
	["46x30mm 40rnd mag", "C1987_40Rnd_46x30_mp7", 15],
	["46x30mm 20rnd mag", "C1987_20Rnd_46x30_mp7", 10],
	["7.62x51mm 5Rnd mag", "Trixie_5x762_Mag", 20],
	[".338 5Rnd mag", "Trixie_5x338_Mag", 20],
	["Mk262 30Rnd mag", "Trixie_30x556_mk262_Mag", 20],
	["7.62x51mm 20Rnd mag", "Trixie_20x762_Mag", 20],
	["7.62x51mm 10Rnd mag", "Trixie_10x762_Mag", 20],
	["12.7x99mm 10Rnd mag", "Trixie_10x127_Mag", 20],
	["Raufoss Mk211 HEIAP 10Rnd mag", "Trixie_10x127_HEIAP_Mag", 20],
	["12.7x99mm HE 10Rnd mag", "Trixie_10x127_HE_Mag", 20],
	["5.45x39mm 30Rnd mag", "hlc_30Rnd_545x39_B_AK", 20],
	["5.45x39mm Tracer 30Rnd mag", "hlc_30Rnd_545x39_T_AK", 20],
	["5.45x39mm EP 30Rnd mag", "hlc_30Rnd_545x39_EP_AK", 20],
	["5.45x39mm Tracer 45Rnd mag", "hlc_45Rnd_545x39_T_AK", 30],
	["7.62x39mm 30Rnd mag", "hlc_30Rnd_762x39_b_ak", 20],
	["7.62x39mm Tracer 30Rnd mag", "hlc_30Rnd_762x39_t_ak", 20],
	["7.62x39mm Tracer 45Rnd mag", "hlc_45Rnd_762x39_t_rpk", 30],
	["7.62x39mm Mixed Tracer 45Rnd mag", "hlc_45Rnd_762x39_m_rpk", 30],
	["7.62x39mm Mixed Tracer 75Rnd mag", "hlc_75Rnd_762x39_m_rpk", 40],
	["12g 00 Buckshot 10Rnd mag", "hlc_10rnd_12g_buck_S12", 20],
	["12g Slugs 10Rnd mag", "hlc_10rnd_12g_slug_S12", 20],
	["GP25/GP30 HE Round", "hlc_VOG25_AK", 125],
	["GP25/GP30 white smoke", "hlc_GRD_white", 50],
	["GP25/GP30 red smoke", "hlc_GRD_red", 50],	
	["GP25/GP30 green smoke", "hlc_GRD_green", 50],
	["GP25/GP30 blue smoke", "hlc_GRD_blue", 50],
	["GP25/GP30 orange smoke", "hlc_GRD_orange", 50],
	["GP25/GP30 purple smoke", "hlc_GRD_purple", 50],
	["7.62x39mm 30Rnd mag", "762x39_30rnds_AK47", 20],
...
[
	...
	["*HoneyBadger Suppressor", "muzzle_HBADGER", 100, "item"],
	["*AK-47 suppressor", "muzzle_AK47", 100, "item"],
	["*AAC Cyclone 7.62", "Trixie_Cyclone", 100, "item"],
	["*AAC Ranger-3 5.56", "Trixie_Ranger3", 100, "item"],
	["*PBS4 Suppressor (5.45x39)", "hlc_muzzle_545SUP_AK", 100, "item"],
	["*PBS1 Suppressor (7.62x39)", "hlc_muzzle_762SUP_AK", 100, "item"],
	["*Kobra optic", "hlc_optic_kobra", 50, "item"],
	["*M68 CCO", "Trixie_M68CCO", 100, "item"],
...
//	["*Night ODA112 Helmet", "Night112_Helmet", 50, "hat"],
	["*Urban Helmet", "Urban_Helmet", 50, "hat"],
	["*Snow Helmet", "snow_Helmet", 50, "hat"],
	["*MLC Helmet", "mlc_Helmet", 50, "hat"],
	["*MLP Helmet", "mlp_Helmet", 50, "hat"],
...
//	["*Night ODB110 Uniform TS", "Night3_TS", 300, "uni"],
	["*Urban Uniform RS", "Urban_RS", 300, "uni"],
	["*Urban Uniform TS", "Urban_TS", 300, "uni"],
	["*Urban Uniform", "UrbanUniform_H", 300, "uni"],
	["*Snow Uniform RS", "snow_RS", 300, "uni"],
	["*Snow Uniform TS", "snow_TS", 300, "uni"],
	["*Snow Uniform", "snowUniform_H", 300, "uni"],
	["*MLC Uniform RS", "mlc_RS", 300, "uni"],
	["*MLC Uniform TS", "mlc_TS", 300, "uni"],
	["*MLC Uniform", "mlcUniform_H", 300, "uni"],
	["*MLP Uniform RS", "mlp_RS", 300, "uni"],
	["*MLP Uniform TS", "mlp_TS", 300, "uni"],
	["*MLP Uniform", "mlpUniform_H", 300, "uni"],
	["*Uniform (Black)", "ice123_uniform", 300, "uni"],
...
//	["*Night ODA112 Platecarrier", "night2_PlateCarrier1", 100, "vest"],
	["*Urban Platecarrier", "Urban_PlateCarrier1", 100, "vest"],
	["*Urban Platecarrier(2)", "Urban_PlateCarrier2", 100, "vest"],
	["*Snow Platecarrier", "snow_PlateCarrier1", 100, "vest"],
	["*Snow Platecarrier(2)", "snow_PlateCarrier2", 100, "vest"],
	["*MLC Platecarrier", "mlc_PlateCarrier1", 100, "vest"],
	["*MLC Platecarrier(2)", "mlc_PlateCarrier2", 100, "vest"],
	["*MLP Platecarrier", "mlp_PlateCarrier1", 100, "vest"],
	["*MLP Platecarrier(2)", "mlp_PlateCarrier2", 100, "vest"],
...
[
	["*Black Skull Balaclava", "Kio_Balaclava_blkSkull", 100, "nvg"],
	["*Black Balaclava", "Kio_Balaclava_blk", 100, "nvg"],
	["*Bandanna (Shades)", "Bandanna_shades_nvg", 100, "nvg"],
	["*Avator glasses", "G_Aviator", 100, "gogg"],
	["*Balaclava (black)(BI)", "G_Balaclava_blk", 100, "gogg"],
	["*Balaclava (Combat Goggles)", "G_Balaclava_combat", 100, "gogg"],
	["*Balaclava (Low Profile Googles)", "G_Balaclava_lowprofile", 100, "gogg"],
...
[
	["*T-34-85M", "RDS_T34_AAF_01", 20000, "vehicle"],
	["*T-55A", "RDS_T55_AAF_01", 20000, "vehicle"],
	["*T-72", "RDS_T72_AAF_01", 20000, "vehicle"],
	["*T-72BM", "RDS_T72BM_AAF_01", 20000, "vehicle"],
	["*ZSU-23-4", "RDS_ZSU_AAF_01", 20000, "vehicle"],
